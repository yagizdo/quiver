...
6. **What Do I Use?** — scenario-based grouped tables; internal reference skills (code-navigation, verification, tdd, visual-companion) are excluded from user-facing docs
...
Slash-invocable skills are listed by their `/<name>` invocation. Internal reference skills (code-navigation, verification, tdd, visual-companion) are excluded from user-facing docs entirely -- they are never listed in the README.
...
- [ ] Internal reference skills (code-navigation, verification, tdd, visual-companion) are excluded from user-facing docs
